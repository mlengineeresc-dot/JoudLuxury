    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition-all group flex flex-col h-full">
            ...
            <div className="p-5 flex-1 flex flex-col">
                <h4 className="font-bold text-lg text-gray-900 truncate mb-1">{item.name}</h4>
                ...
                <div className="flex items-center gap-1.5 text-blue-600 text-xs font-bold mb-3">
                    Quantity Left: {item.quantity} / {item.initialQuantity}
                </div>
                ...
                <div className="mt-auto space-y-4">
                    <div className="grid grid-cols-2 gap-2 text-sm pt-4 border-t border-gray-100">
                        <div>
                    ...
                    {item.isSold ? (
                        <div className={`p-3 rounded-xl flex justify-between items-center ${item.actualProfit >= 0 ? 'bg-emerald-50 text-emerald-700' : 'bg-red-50 text-red-700'}`}>
                        ...
                        <div className="relative space-y-2">
                            {item.actualProfit !== 0 && (
                                <div className={`p-2 rounded-xl flex justify-between items-center ${item.actualProfit >= 0 ? 'bg-emerald-50 text-emerald-700' : 'bg-red-50 text-red-700'}`}>
                            ...
                            {showSoldOptions ? (
                                <div className="bg-gray-50 p-3 rounded-xl border border-gray-200 animate-in fade-in slide-in-from-bottom-2">
