...
export const ItemCard: React.FC<{ item: Item; variant?: 'detailed' | 'library' }> = ({ item, variant = 'detailed' }) => {
                                        ...
                                        {showSoldOptions ? (
                                            <div className="bg-gray-50 p-3 rounded-xl border border-gray-200 animate-in fade-in slide-in-from-bottom-2 text-left">
                                                ...
                                                <div className="flex gap-2 mt-2">
                                                    <button
                                                        onClick={() => setShowSoldOptions(false)}
                                                        className="flex-1 bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 px-3 py-2 rounded-lg font-bold text-sm transition-colors"
                                                    >
                                                        Cancel
                                                    </button>
                                                    <button
                                                        onClick={handleMarkAsSold}
                                                        className="flex-1 bg-emerald-500 hover:bg-emerald-600 text-white px-3 py-2 rounded-lg font-bold text-sm transition-colors"
                                                    >
                                                        Confirm
                                                    </button>
                                                </div>
